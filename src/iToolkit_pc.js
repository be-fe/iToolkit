...
riot.tag('itk-slide', '<ul id="slide-wrap"> <yield></yield> </ul> <a href="javascript:;" id="prev" class="arrow">《</a> <a href="javascript:;" id="next" class="arrow">》</a> <div class="slide-btn-wrap" id="slide-btn-wrap"> <div id="slide-btn-container"> </div> </div>', 'itk-slide { display: block; overflow: hidden; padding: 0; position: relative; margin: 0; } itk-slide ul { display: block; overflow: hidden; padding: 0; margin: 0; position: relative; } itk-slide ul li { display: block; float: left; ul-style: none; list-style: none; padding: 0; margin: 0; } itk-slide .slide-btn-wrap { width: 100%; height: 50px; background-color: rgba(0, 0, 0, .3); position: relative; top: -50px; } itk-slide #slide-btn-container { width: 100px; height: 50px; margin: 0 auto; } itk-slide .slide-btn-wrap span { cursor: pointer; float: left; border: 1px solid #fff; width: 10px; height: 10px; border-radius: 50%; background: #333; margin-right: 5px; margin-left: 5px; margin-top: 20px; } itk-slide .slide-btn-wrap .on { background: orangered; } itk-slide .arrow { display: block; cursor: pointer; line-height: 50px; text-align: center; font-size: 36px; font-weight: bold; width: 40px; height: 50px; position: absolute; z-index: 100; background-color: RGBA(0, 0, 0, .3); color: #fff; top: 50%; text-decoration: none; } itk-slide #prev { left: 20px; } itk-slide #next { right: 20px; }', function(opts) {
